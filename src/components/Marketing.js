...
class Marketing extends React.Component {
  render() {
    return (<div className="uk-section uk-section-muted uk-section-large">
      <div className="uk-container">
        <div className="uk-child-width-expand@s" data-uk-grid="data-uk-grid">
          <div>
            <h1 className="uk-text-center">{'Meets'}</h1>
            <p>{"We meet every Thursday from 6:30 to 7 P.M. in Lot Z at the University Of Maryland, College Park campus. Don't come late or you might miss the cruise!"}</p>
          </div>
          <div>
