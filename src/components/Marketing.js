            ...
            <div className="uk-container">
                <div className="uk-child-width-expand@s" data-uk-grid>
                    ...
                    <div>
                        ...
                        <p>{'We cruise to a random destination after every meet. Underground car shows, new resteraunts, and various scenic overlooks are perfect spots for admiring our cars.'}</p>
                    </div>
                </div>
